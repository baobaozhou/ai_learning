...
###############翻译
hidden_size = 100
checkpoint_dir = '/home/zutnlp/pycharm/zutnlp_english_translation/checkpoints/'
...
def main():
    ...
    with tf.Session() as sess:
        ...
        # A bucket scale is a list of increasing numbers from 0 to cpdp_data that we'll use
        # to select a bucket. Length of [scale[i], scale[i+cpdp_data]] is proportional to
        ...
        while True:
            ...
            # in [0, cpdp_data] and use the corresponding interval in train_buckets_scale.
            ...
            if current_step % steps_per_checkpoint == 0:
                ...
                for bucket_id in xrange(len(_buckets)):
                    ...
                    # outputs = [int(np.argmax(logit, axis=cpdp_data)) for logit in output_logits]
