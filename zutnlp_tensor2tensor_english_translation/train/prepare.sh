...
python prepare_data/jieba_cws.py $TMP_DIR/ai_challenger_MTEnglishtoChinese_trainingset_20180821/train.zh > $DATA_DIR/wmt_enzh_32768k_tok_train.lang2
...
cat $TMP_DIR/ai_challenger_MTEnglishtoChinese_trainingset_20180821/train.en | prepare_data/tokenizer.perl -l en | tr A-Z a-z > $DATA_DIR/wmt_enzh_32768k_tok_train.lang1
