...
data_dir = r'E:\Pycharm\工程\zutnlp_english_translation\data'
data_english = r'E:\Pycharm\工程\zutnlp_english_translation\data\from'
data_chinese = r'E:\Pycharm\工程\zutnlp_english_translation\data\to'
vocabulary_fileen = 'dicten.txt'
vocabulary_filech = 'dictch.txt'
