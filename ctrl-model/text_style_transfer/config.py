...
train_data = {
    ...
    'datasets': [
        {
            'files': './data/sentiment.train.text',
            'vocab_file': './data/vocab',
            'data_name': ''
        },
        {
            'files': './data/sentiment.train.labels',
            'data_type': 'int',
            'data_name': 'labels'
        }
    ],
...
val_data['datasets'][0]['files'] = './data/sentiment.dev.text'
val_data['datasets'][1]['files'] = './data/sentiment.dev.labels'

test_data = copy.deepcopy(train_data)
test_data['datasets'][0]['files'] = './data/sentiment.test.text'
test_data['datasets'][1]['files'] = './data/sentiment.test.labels'
